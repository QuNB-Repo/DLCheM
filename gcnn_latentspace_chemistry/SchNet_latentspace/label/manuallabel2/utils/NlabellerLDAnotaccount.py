...
def label(connections_to_atom,xyz_file_read,mol_file_read,number_atoms,each_molecule,each_atom):
    ...
    if total == 4:
        ...
        if countC == 3 and countO == 1:
            ...
            gnucolor = 11591910
            gnumarker = 11
    #THESE ARE THE NEW UPDATES---> NOT ADDED TO LEGEND/KEY FIGURE
    if total == 3:
        ##This is NEW (NEEDS TO BE ADDED TO LEGEND) firstqm9 = 21516
        #NOT ADDED TO THE  LDACONT ONE (because of domino effect)
