...
def extract(db_file_path,model_filepath,save_filepath,layer,n_features,n_molecules,n_carbons,cutoff,target_element):
...
#        props['_atomic_numbers'] = props['atomic_numbers'][dist_tooxygen.argsort()]
