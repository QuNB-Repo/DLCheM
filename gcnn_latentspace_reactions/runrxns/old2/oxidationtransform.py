...
class oxidation():
    ...
    def write_trans_string(self,init_xyz_string,H1_index_in_xyzmol,H2_index_in_xyzmol):
        countH_inxyz = 0
...
#            H_index  = oxidation.indexer(props,each_molecule,labelH)
            ...
            if np.count_nonzero(atomic_numbers==8) == 1: 
                ...
                if H1_found and H2_found == True:
                    ...
                    init_xyz_string = oxidation.write_init_string(self,atomic_numbers,numb_atoms,xyz_positions)

#                   scratch_xyz_filename = self.scratch_file + '.xyz' 
                    self.init_dataset_xyzfile.write(init_xyz_string)

                    #make transformed xyz
                    trans_xyz_string = oxidation.write_trans_string(self,init_xyz_string,H1_index_in_xyzmol,H2_index_in_xyzmol)
