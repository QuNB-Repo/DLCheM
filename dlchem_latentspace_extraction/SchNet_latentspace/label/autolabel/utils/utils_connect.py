...
def depth_label(adj_idx_matrix,adj_ele_matrix,target_connect_list,target_element_list,n_depth):
    ...
    return target_depth_elements


def order_branches_in_each_depth(target_depth_elements,n_depth):
    '''
    ...
    is the SAME and consistent throughout
        ...
        target_depth_elements   - the result of the depth_label on the ordered adjacency/branches
    ...
    for each_depth in range(len(target_depth_elements)):
        ...
        newbranch_order = []
        if n_branch == 1:
            newbranch_order = target_depth_elements[each_depth]
        ...
        #replace n_depth
        target_depth_elements[each_depth] = newbranch_order
